...
QT_MOC_LITERAL(3, 34, 17) // "pushButtonClicked"

    },
    "calcDialog\0on_buttonBox_accepted\0\0"
    "pushButtonClicked"
};
...
const QMetaObject calcDialog::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_calcDialog.data,
      qt_meta_data_calcDialog,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
