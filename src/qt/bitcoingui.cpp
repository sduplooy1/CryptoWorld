    ...
    rpcConsole(0)
{
    ...
    QString windowTitle = tr("CryptoWorld") + " - " + tr("Wallet");
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setToolTip(tr("Send coins to a CryptoWorld address"));
    ...
    aboutAction = new QAction(QIcon(":/icons/bitcoin"), tr("&About CryptoWorld"), this);
    aboutAction->setToolTip(tr("Show information about CryptoWorld"));
    ...
    optionsAction->setToolTip(tr("Modify configuration options for CryptoWorld"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("CryptoWorld client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to CryptoWorld network", "", count));
}
...
void BitcoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            notificator->notify(Notificator::Warning, tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid CryptoWorld address or malformed URI parameters."));
    }
