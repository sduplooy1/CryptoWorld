...
public:
    ...
    QPushButton *stakeForCharityPushButton;
    ...
    void setupUi(QWidget *AddressBookPage)
    {
        ...
        stakeForCharityPushButton = new QPushButton(AddressBookPage);
        stakeForCharityPushButton->setObjectName(QStringLiteral("stakeForCharityPushButton"));
        QIcon icon5;
        icon5.addFile(QStringLiteral(":/icons/send"), QSize(), QIcon::Normal, QIcon::Off);
        stakeForCharityPushButton->setIcon(icon5);

        horizontalLayout->addWidget(stakeForCharityPushButton);
    ...
    void retranslateUi(QWidget *AddressBookPage)
    {
        ...
        labelExplanation->setText(QApplication::translate("AddressBookPage", "These are your HyperStake addresses for receiving payments. You may want to give a different one to each sender so you can keep track of who is paying you.", 0));
#ifndef QT_NO_TOOLTIP
        tableView->setToolTip(QApplication::translate("AddressBookPage", "Double-click to edit address or label", 0));
#endif // QT_NO_TOOLTIP
        deleteCheckBox->setText(QApplication::translate("AddressBookPage", "Enable Deletion of Receiving Address - WARNING YOU WILL LOSE KEYS TO ANY COINS AT THE ADDRESS, BACK UP WALLET FIRST!", 0));
#ifndef QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        signMessage->setToolTip(QApplication::translate("AddressBookPage", "Sign a message to prove you own a HyperStake address", 0));
#endif // QT_NO_TOOLTIP
        signMessage->setText(QApplication::translate("AddressBookPage", "Sign &Message", 0));
#ifndef QT_NO_TOOLTIP
        verifyMessage->setToolTip(QApplication::translate("AddressBookPage", "Verify a message to ensure it was signed with a specified HyperStake address", 0));
#endif // QT_NO_TOOLTIP
        verifyMessage->setText(QApplication::translate("AddressBookPage", "&Verify Message", 0));
#ifndef QT_NO_TOOLTIP
        stakeForCharityPushButton->setToolTip(QApplication::translate("AddressBookPage", "Send a percentage of stake to a specified HyperStake address", 0));
#endif // QT_NO_TOOLTIP
        stakeForCharityPushButton->setText(QApplication::translate("AddressBookPage", "&Stake For Charity", 0));
#ifndef QT_NO_TOOLTIP
