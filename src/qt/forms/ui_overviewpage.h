...
public:
    ...
    void setupUi(QWidget *OverviewPage)
    {
        ...
        labelBalance->setText(QStringLiteral("0 HYP"));
        ...
        labelStake->setText(QStringLiteral("0 HYP"));
        ...
        labelUnconfirmed->setText(QStringLiteral("0 HYP"));
        ...
        labelImmature->setText(QStringLiteral("0 HYP"));
        ...
        coinLogo = new QLabel(OverviewPage);
        coinLogo->setObjectName(QStringLiteral("coinLogo"));
        coinLogo->setPixmap(QPixmap(QString::fromUtf8(":/images/backg")));
        coinLogo->setScaledContents(false);
        coinLogo->setAlignment(Qt::AlignCenter);
        coinLogo->setMargin(-2);

        verticalLayout_2->addWidget(coinLogo);
    ...
    void retranslateUi(QWidget *OverviewPage)
    {
        ...
        labelWalletStatus->setToolTip(QApplication::translate("OverviewPage", "The displayed information may be out of date. Your wallet automatically synchronizes with the HyperStake network after a connection is established, but this process has not completed yet.", 0));
#endif // QT_NO_TOOLTIP
...
#endif // QT_NO_TOOLTIP
        coinLogo->setText(QString());
        label_4->setText(QApplication::translate("OverviewPage", "<b>Recent transactions</b>", 0));
#ifndef QT_NO_TOOLTIP
        labelTransactionsStatus->setToolTip(QApplication::translate("OverviewPage", "The displayed information may be out of date. Your wallet automatically synchronizes with the HyperStake network after a connection is established, but this process has not completed yet.", 0));
#endif // QT_NO_TOOLTIP
    } // retranslateUi
