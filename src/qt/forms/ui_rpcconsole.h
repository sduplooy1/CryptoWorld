...
public:
    ...
    {
        RPCConsole->setWindowTitle(QApplication::translate("RPCConsole", "HyperStake - Debug window", 0));
        label_9->setText(QApplication::translate("RPCConsole", "HyperStake Core", 0));
        ...
        openDebugLogfileButton->setToolTip(QApplication::translate("RPCConsole", "Open the HyperStake debug log file from the current data directory. This can take a few seconds for large log files.", 0));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        showCLOptionsButton->setToolTip(QApplication::translate("RPCConsole", "Show the HyperStake-Qt help message to get a list with possible HyperStake command-line options.", 0));
#endif // QT_NO_TOOLTIP
