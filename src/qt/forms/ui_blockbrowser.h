...
public:
    ...
    void setupUi(QDialog *BlockBrowser)
    {
        ...
        labelBlockExplorer->setObjectName(QStringLiteral("labelBlockExplorer"));
        ...
        labelBlockExplorer->setStyleSheet(QStringLiteral("font-weight:bold;"));
    ...
    {
        BlockBrowser->setWindowTitle(QApplication::translate("BlockBrowser", "Block Browser", 0));
        labelBlockExplorer->setText(QApplication::translate("BlockBrowser", "Block Browser", 0));
        ...
        hashRateBox->setText(QApplication::translate("BlockBrowser", "0000 MH/s", 0));
        ...
        diffBox->setText(QApplication::translate("BlockBrowser", "0.00", 0));
        txID->setText(QApplication::translate("BlockBrowser", "000", 0));
        inputBox->setText(QString());
        valueBox->setText(QString());
        diffLabel->setText(QApplication::translate("BlockBrowser", "Block Difficulty:", 0));
        heightLabelBE2->setText(QApplication::translate("BlockBrowser", "Block Height:", 0));
        ...
        hashRateLabel->setText(QApplication::translate("BlockBrowser", "Block Hashrate:", 0));
        heightLabelBE1->setText(QApplication::translate("BlockBrowser", "0", 0));
        ...
        closeButton->setText(QApplication::translate("BlockBrowser", "Close", 0));
    } // retranslateUi
