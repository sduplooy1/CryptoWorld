...
#define PACKAGE_BUGREPORT "info@hyperstake.info"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Hyperstake Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Hyperstake Core 1.1.4"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "hyperstake"
